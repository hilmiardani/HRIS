...
export default function Logout({ className }: IconProps) {
  return <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M21.8096 12.0214H9.76855" stroke="currentcolor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M18.8811 9.1063L21.8091 12.0213L18.8811 14.9373" stroke="currentcolor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
}
